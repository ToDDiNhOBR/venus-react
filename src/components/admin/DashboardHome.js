...
const DashboardHome = () => {
  return (
    <div className="relative min-h-[80vh] flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-blue-900 p-6 overflow-hidden">
      {/* Background Effects */}
        ...
        <div className="relative w-[500px] h-[500px] bg-gradient-to-br from-gray-800/80 to-gray-900/80 rounded-full border border-gray-700 backdrop-blur-xl flex items-center justify-center shadow-2xl">
          ...
          <div className="absolute left-0 -translate-x-1/2">
            ...
            >
              ...
              <div className="absolute -bottom-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <span className="text-blue-400 text-sm">Gerenciar Orçamentos</span>
              </div>
            </Link>
          </div>
          ...
          <div className="absolute right-0 translate-x-1/2">
            ...
            >
              ...
              <div className="absolute -bottom-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <span className="text-purple-400 text-sm">Gerenciar Clientes</span>
              </div>
            </Link>
          </div>
        </div>
